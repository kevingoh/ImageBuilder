...
if [ $(grep "FIRST_TIME_SETUP_COMPLETED" $WORDPRESS_LOCK_FILE) ]; then
    ...
    unison /home/site/wwwroot /var/www/wordpress/ -auto -batch -times -copythreshold 1000 -dontchmod -prefer /home/site/wwwroot -ignore 'Path wp-content/uploads' -perms 0 -logfile $UNISON_LOG_DIR/unison.log
    # -silent -fastercheckUNSAFE 
